...
// You can create a class based on an existing class. This is called "class inheritance" or "subclasssing".
...
// Classes are "reference-type" but structs are "Value-type".
class Singer {
