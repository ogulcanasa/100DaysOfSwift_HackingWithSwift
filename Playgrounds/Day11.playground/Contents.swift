...
// Id string that can be read (“get”) or written (“set”):
...
// One protocol can inherit from another in a process known as protocol inheritance. Unlike with classes, you can inherit from multiple protocols at the same time
