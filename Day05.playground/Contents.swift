...
// 7.Variadic functions (Some functions are variadic, which is a fancy way of saying they accept any number of parameters of the same type. print() function is actually variadic: if you pass lots of parameters, they are all printed on one line)
...
// 10.inout parameters (If you want to double a number in place - change the  value directly rather than returning a new one - you might write a function with "inout")
